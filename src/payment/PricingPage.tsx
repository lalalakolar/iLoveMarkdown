...
export const paymentPlanCards: Record<PaymentPlanId, PaymentPlanCard> = {
  [PaymentPlanId.Hobby]: {
    ...
    features: ["文件大小限制 10MB", "每日转换限额 10 次", "基础转换功能", "标准支持"],
  },
  [PaymentPlanId.Pro]: {
    name: prettyPaymentPlanName(PaymentPlanId.Pro),
    price: "$9.99",
    description: "适合专业用户的高级功能",
    features: ["文件大小限制 50MB", "无限转换次数", "批量处理功能", "优先转换队列", "格式优化", "优先客户支持"],
  },
  [PaymentPlanId.Credits10]: {
    name: prettyPaymentPlanName(PaymentPlanId.Credits10),
    price: "$4.99",
    description: "一次性购买 10 次额外转换次数",
    features: ["可用于任何转换类型", "无过期日期", "适用于免费版用户"],
  },
};
